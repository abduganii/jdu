...
export default function RangeInput({ lessonType, color, defaultRange = 0, onChange, ...other }) {
    ...
    return (
        <div className={cls.RangeInput} {...other}>
            ...
            <div className={cls.RangeInput__wrap}>
                ...
                <input className={cls.RangeInput__input} style={{ background: color, WebkitSliderThumb: color }} type="range"
